...
if (changeModus){
  switch (programMode){ 
      ...
      case 24: {       effect_function = sparkling_2;       if (selectedPresetVariable != 0){ loadPersonalSettings(); } else { BriSPreset=0;           changeSpeed=135;        setDifference=7;      colorMode=1;                   varON=1;   }; if (selectedPresetVariable == 0 || numsparks == 10){numsparks=3*cfactor2;  }; yval1=random(125,225);       sparkSpeed=98;      yy=0;        hh=NUM_LEDS;        variant=0;        offmin=13*cfactor2;        offmax=10*cfactor2;        offdis=1;        readyToChange = true;        } break;                       
