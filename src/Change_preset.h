...
if (changeModus){
  switch (programMode){ 
    case 0: {        effect_function = static_glow;       if (personalizedModes == true){ loadPersonalSettings(); } else { BriSPreset=3;           changeSpeed=100;        setDifference=7;      colorMode=0;      yval1=10;       }; forcedColourChange = true  ;} break;
    ...
    case 6: {        effect_function = palettes;          if (personalizedModes == true){ loadPersonalSettings(); } else { BriSPreset=9;           changeSpeed=50;         setDifference=1;      gCurrentPaletteNumber=7;          };    gTargetPalette = gGradientPalettes[gCurrentPaletteNumber];  y0r=0;   } break;
    ...
    case 8: {        effect_function = rainbow_1;         if (personalizedModes == true){ loadPersonalSettings(); } else { BriSPreset=8;           changeSpeed=20;         setDifference=1;      colorMode=0;    arrayn=7;         selectcolorArray();     };} break;
    ...
    case 13: {       effect_function = rainbow_6;         if (personalizedModes == true){ loadPersonalSettings(); } else { BriSPreset=0;           changeSpeed=3578;       setDifference=25;                                       colorlength=10*cfactor2; };  y0rCounter=0;         numcolor=1;        yint=0;        colour[0] = 75;        colour[1] = 230;        colour[2] = 175;        colour[3] = 25;        colour[4] = 100;        colour[5] = 200;        colour[6] = 50;        colour[7] = 150;        colour[8] = 0;        colour[9] = 125;} break;    
    ...
    case 29: {       effect_function = pers_color;        if (personalizedModes == true){ loadPersonalSettings(); } else { BriSPreset=7;           changeSpeed=2000;                             colorMode=4;    arrayn=27;        colorlength=10*cfactor2;       selectcolorArray();   numcolor=5;};   } break;      
    ...
    case 33: {       effect_function = xmas_solid;        if (personalizedModes == true){ loadPersonalSettings(); } else { BriSPreset=0;           changeSpeed=40;         setDifference=7;                                         }; offdis=5;        ysr=0; numsparks=0 ;} break;                            
