...
if (changeModus){
  switch (programMode){ 
    ...
    case 33: {       effect_function = xmas_solid;        if (personalizedModes == true){ loadPersonalSettings(); } else { BriSPreset=0;           changeSpeed=40;         setDifference=7;                                        }; offdis=5;        ysr=0; X;} break;                            
