...
if (changeModus){
  switch (programMode){ 
      ...
      case 9: {        effect_function = rainbow_2;         if (selectedPresetVariable != 0){ loadPersonalSettings(); } else { BriSPreset=2;           changeSpeed=30;         setDifference=4;      colorMode=0;    arrayn=7;      varON=1;   selectcolorArray();     };} break;
      ...
      case 12: {       effect_function = rainbow_5;         if (selectedPresetVariable != 0){ loadPersonalSettings(); } else { BriSPreset=0;           changeSpeed=30;         setDifference=5;                                     varON=1;   }; if (tower) {offdis=1;} else {offdis=3;}    } break;   
      ...
      case 15: {       effect_function = gradient;          if (selectedPresetVariable != 0){ loadPersonalSettings(); } else { BriSPreset=6;           changeSpeed=200;        setDifference=1;      colorMode=0;                   varON=1;   }; yval1=ymin4;        } break;
      case 16: {       effect_function = s7_strings;        if (selectedPresetVariable != 0){ loadPersonalSettings(); } else { BriSPreset=0;           changeSpeed=110;        setDifference=10;     colorMode=4;    arrayn=0;      varON=1;   selectcolorArray();   numsparks=5*cfactor2;  };     ir[0]=0;        ir[1]=0;    previousMillis9=millis();        previousMillis10=millis();        previousMillis12=millis();          } break;
      ...
      case 18: {       effect_function = s7_strings;        if (selectedPresetVariable != 0){ loadPersonalSettings(); } else { BriSPreset=0;           changeSpeed=110;        setDifference=95;     colorMode=4;    arrayn=0;      varON=1;   selectcolorArray();   numsparks=5*cfactor2; };     ir[0]=0;        ir[1]=0;    previousMillis9=millis();        previousMillis10=millis();        previousMillis12=millis();           } break;
      case 19: {       effect_function = snow_flakes;       if (selectedPresetVariable != 0){ loadPersonalSettings(); } else { BriSPreset=0;           changeSpeed=125;        setDifference=7;      colorMode=4;    arrayn=0;      varON=1;   selectcolorArray();   numsparks=7*cfactor2;  };   offdis = offdisC;       sF=1;           previousMillis8=millis();     } break;        
      case 20: {       effect_function = snow_flakes_2;     if (selectedPresetVariable != 0){ loadPersonalSettings(); } else { BriSPreset=0;           changeSpeed=125;        setDifference=7;      colorMode=1;                   varON=1;   numsparks=7*cfactor2; }; sF=1;      offdis = offdisC;      partialArrayCounter=0;     forcedColourChange = true;      } break;
      case 21: {       effect_function = snow_storm;        if (selectedPresetVariable != 0){ loadPersonalSettings(); } else { BriSPreset=0;           changeSpeed=130;        setDifference=7;      colorMode=1;                   varON=1;   numsparks=5*cfactor2;}; yval1=random(125,225);        hh=NUM_LEDS;        offmin=1;        offmax=1;     sparkSpeed=120;       rrhh=-1;        poshh=-1;        flakeCounter=0;    offdis=cfactor2;   } break;       
      case 22: {       effect_function = snow_flakesR;      if (selectedPresetVariable != 0){ loadPersonalSettings(); } else { BriSPreset=0;           changeSpeed=125;        setDifference=7;                                     varON=1;   numsparks=7*cfactor2; }; offdis = offdisC;           sF=1;         previousMillis8=millis();     } break;
      case 23: {       effect_function = sparkling;         if (selectedPresetVariable != 0){ loadPersonalSettings(); } else { BriSPreset=0;           changeSpeed=130;        setDifference=7;      colorMode=2;                   varON=1;   numsparks=10*cfactor2;}; sparkSpeed=78;                        sparkSpeed=98;        yval1=random(125,225);        yy=0;        hh=NUM_LEDS;    variant=0;        offmin=15*cfactor2;        offmax=15*cfactor2;        offdis=1;       readyToChange = true;      } break;                 
      case 24: {       effect_function = sparkling_2;       if (selectedPresetVariable != 0){ loadPersonalSettings(); } else { BriSPreset=0;           changeSpeed=135;        setDifference=7;      colorMode=1;                   varON=1;   numsparks=cfactor2*3;  }; yval1=random(125,225);       sparkSpeed=98;      yy=0;        hh=NUM_LEDS;        variant=0;        offmin=13*cfactor2;        offmax=10*cfactor2;        offdis=1;        readyToChange = true;         numcolor=5; } break;                       
      case 25: {       effect_function = sparklingR;        if (selectedPresetVariable != 0){ loadPersonalSettings(); } else { BriSPreset=0;           changeSpeed=130;        setDifference=7;                                     varON=1;   numsparks=10*cfactor2;}; sparkSpeed=78;                 sparkSpeed=98;        yval1=random(125,225);        yy=0;        hh=NUM_LEDS;    variant=0; offmin=15*cfactor2;        offmax=15*cfactor2;        offdis=1;       readyToChange = true;     } break;
      ...
      case 36: {       effect_function = meteor;            if (selectedPresetVariable != 0){ loadPersonalSettings(); } else { BriSPreset=0;           changeSpeed=50;         setDifference=10;     colorMode=2;                   varON=1;   numsparks=cfactor2*5;}; flakeCounter=0;               offmin=13;        offmax=13;     offdis = offdisC;       hh=NUM_LEDS;          endFlag=false;    poshh=NUM_LEDS;   if (tower){slingerSpeed=45/cfactor2;} else {slingerSpeed = changeSpeed;} ;} break; // for (int s=0;s<30; s++){y[s]=offdisC;}   
