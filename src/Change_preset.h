...
if (changeModus){
  switch (programMode){ 
    case 0: {        effect_function = static_glow;       if (personalizedModes == true){ loadPersonalSettings(); } else { BriSPreset=22;          changeSpeed=100;        setDifference=7;      colorMode=0;      yval1=10;       }; forcedColourChange = true  ;} break;
    ...
    case 2: {        effect_function = static_glow;       if (personalizedModes == true){ loadPersonalSettings(); } else { BriSPreset=23;          changeSpeed=100;        setDifference=9;      colorMode=0;      yval1=24;       }; forcedColourChange = true ;} break;
