...
if (changeModus){
  switch (programMode){ 
    ...
    case 7: {        effect_function = s7_strings;        changeSpeed=110;          colorMode=4;             setDifference=15;               arrayn=0; selectcolorArray();        ir[0]=0;        ir[1]=0;    previousMillis9=millis();        previousMillis10=millis();        previousMillis12=millis();    numsparks=5*cfactor2;     rainbowON = true;
                      for (int k=0; k<21; k++){i[k] = NUM_LEDS-1;}                                                                                                                            } break;
        
    case 8: {        effect_function = s7_strings;     changeSpeed=110;       colorMode=4;        setDifference=15;       arrayn=0;   selectcolorArray();        i[0]=NUM_LEDS-1;        numsparks=1;        previousMillis9=millis();        previousMillis10=millis();        previousMillis12=millis();     rainbowON = true; } break;                    
    case 9: {        effect_function = snow_flakes;        changeSpeed=125;          colorMode=4;           setDifference=7;    offdis = offdisC;                arrayn=0;  selectcolorArray();        sF=1;           previousMillis8=millis();     numsparks=7*cfactor2;
                      for (int k=0; k<21; k++){i[k]=NUM_LEDS-1; a[k]=NUM_LEDS-1;}} break;         

    case 10: {       effect_function = snow_flakes_2;        changeSpeed=125;        setDifference=7;        colorMode=1;        sF=1;      offdis = offdisC;      partialArrayCounter=0;     forcedColourChange = true;     numsparks=7*cfactor2; 
                      for (int k=0; k<21; k++){i[k]=NUM_LEDS-1; a[k]=NUM_LEDS-1;}            } break;

    case 11: {       effect_function = sparkling;         changeSpeed=130;       sparkSpeed=78;         colorMode=2;        setDifference=7;         sparkSpeed=98;        yval1=random(125,225);        yy=0;        hh=NUM_LEDS-1;    variant=0;        offmin=15*cfactor2;        offmax=15*cfactor2;        offdis=1;       readyToChange = true;      numsparks=10*cfactor2;
                      for (int s=0; s<30;s++){rr[s]=-1;        pos[s]=NUM_LEDS-1;}        } break;
                      
    case 12: {       effect_function = sparkling_2;        changeSpeed=180;        setDifference=7;        colorMode=1;        yval1=random(125,225);       sparkSpeed=98;      yy=0;        hh=NUM_LEDS-1;        variant=0;        offmin=13*cfactor2;        offmax=10*cfactor2;        offdis=1;        readyToChange = true;       INTERVAL7=5000;        numsparks=cfactor2*3;        numcolor=5;       colour[0]=217;        colour[1]=164;        colour[2]=0;        colour[3]=96;        colour[4]=55;            colour[5]=140;
    ...
    case 13: {       effect_function = snow_storm;        changeSpeed=130;        colorMode=1;        setDifference=7;        yval1=random(125,225);        hh=NUM_LEDS-1;        offmin=1;        offmax=1;     sparkSpeed=120;       rrhh=-1;        poshh=-1;        flakeCounter=0;    offdis=cfactor2;   numsparks=5*cfactor2;
                      for (int s=0; s<30; s++){rr[s]=-1;        pos[s]=NUM_LEDS-1;}        } break;                        
    ...
    case 31: {       effect_function = demo100;        changeSpeed=20;          setDifference=1;       offdis=5;    numsparks=0;} break; 
    ...
    case 33: {       effect_function = snow_storm;        changeSpeed=130;        colorMode=1;        yval=142;        yval1=142;       glowON=2;       varON=2;         BRIGH=106;       BrF=150;      S=180;      sparkSpeed=120;         setDifference=7;                hh=NUM_LEDS-1;        offmin=1;        offmax=1;       rrhh=-1;        poshh=-1;        flakeCounter=0;      offdis=cfactor2;     numsparks=30; // S=142;
                      for (int s=0; s<30; s++){rr[s]=-1;        pos[s]=NUM_LEDS-1;}        } break;
    ...
    case 35: {       effect_function = snow_flakesR;        changeSpeed=125;         setDifference=7;      offdis = offdisC;           sF=1;         previousMillis8=millis();     numsparks=7*cfactor2;
                      for (int k=0; k<21; k++){i[k]=NUM_LEDS-1; a[k]=NUM_LEDS-1;}} break;      
