...
if (changeModus){
  switch (programMode){ 
    ...
    case 36: {       effect_function = sparklingR;         changeSpeed=130;       sparkSpeed=78;         colorMode=2;        setDifference=7;         sparkSpeed=98;        yval1=random(125,225);        yy=0;        hh=NUM_LEDS;;    variant=0;        offmin=15*cfactor2;        offmax=15*cfactor2;        offdis=1;       readyToChange = true;      numsparks=10*cfactor2;} break;  
