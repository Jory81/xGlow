...
if (changeModus){
  switch (programMode){ 
    ...
    case 33: {       effect_function = snow_storm;        changeSpeed=130;        colorMode=1;        yval=142;        yval1=142;       glowON=2;       varON=2;         BRIGH=106;       BrF=150;      S=180;      sparkSpeed=120;         setDifference=7;                hh=NUM_LEDS;        offmin=1;        offmax=1;       rrhh=-1;        poshh=-1;        flakeCounter=0;      offdis=cfactor2;     numsparks=30;} break;
