...
if (changeModus){
  switch (programMode){ 
      ...
      case 14: {       effect_function = rainbow_7;         if (personalizedModes == true){ loadPersonalSettings(); } else { BriSPreset=0;           changeSpeed=100;        setDifference=1;                                        }; dir1 = 1;    offdis=5;        y0r=ymin3+10;        colorCount=0;        ledspercolor=NUM_LEDS/range; if (ledspercolor > 3){ledspercolor=3;} ;} break;   
      ...
      case 26: {       effect_function = twinkle;           if (personalizedModes == true){ loadPersonalSettings(); } else { BriSPreset=0;           changeSpeed=30;         setDifference = qmul8(cfactor2, 85);      colorMode=1;  };} break;
