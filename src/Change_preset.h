...
if (changeModus){
  switch (programMode){ 
    ...
    case 2: {        effect_function = static_glow;       if (personalizedModes == true){ loadPersonalSettings(); } else { BriSPreset=0;           changeSpeed=100;        setDifference=25;     colorMode=0;      yval1=5;        }; forcedColourChange = true ;} break;
