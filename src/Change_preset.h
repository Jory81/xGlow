...
if (changeModus){
  switch (programMode){ 
    ...
    case 9: {        effect_function = rainbow_2;         if (personalizedModes == true){ loadPersonalSettings(); } else { BriSPreset=0;           changeSpeed=30;         setDifference=4;      colorMode=0;    arrayn=7;         selectcolorArray();     };} break;
    ...
    case 33: {       effect_function = xmas_solid;        if (personalizedModes == true){ loadPersonalSettings(); } else { BriSPreset=0;           changeSpeed=100;         setDifference=7;                                         }; offdis=5;        ysr=0; numsparks=0 ;} break;                            
