...
if (changeModus){
  switch (programMode){ 
      ...
      case 28: {       effect_function = s7_strings_2;        if (selectedPresetVariable != 0){ loadPersonalSettings(); } else { BriSPreset=0;           changeSpeed=110;        setDifference=10;     colorMode=4;    arrayn=0;      varON=1;   selectcolorArray();   }; if (selectedPresetVariable == 0 || numsparks == 10){numsparks=5*cfactor2;  };     ir[0]=0;        ir[1]=0;    previousMillis9=millis();        previousMillis10=millis();        previousMillis12=millis();          } break;
      ...
      case 33: {       effect_function = snow_flakes2;       if (selectedPresetVariable != 0){ loadPersonalSettings(); } else { BriSPreset=0;           changeSpeed=125;        setDifference=7;      colorMode=4;    arrayn=0;      varON=1;   selectcolorArray();    }; if (selectedPresetVariable == 0 || numsparks == 10){numsparks=7*cfactor2;  };   offdis = offdisC;       sF=1;           previousMillis8=millis();     } break;
